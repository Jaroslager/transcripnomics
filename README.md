...
Deze GitHub-repository bevat alle data, R-scripts en resultaten die zijn verkregen binnen het transcriptomics-project. De mappenstructuur is zo opgezet dat er een duidelijk onderscheid wordt gemaakt tussen de verschillende onderdelen: ruwe data, outputbestanden, figuren, bronnen en een flowschema. Bestanden hebben consequente en beschrijvende namen, zodat direct duidelijk is wat ze bevatten. Alle analysecodes zijn vastgelegd in een R-script, inclusief de gebruikte R-pakketten en referentiebestanden. Dit vormt de basis voor goed versiebeheer, waarbij aanpassingen worden bijgehouden zodat eerdere versies altijd terug te halen zijn. Dit maakt het mogelijk om elke stap te reproduceren. De data wordt veilig bewaard met beperkte toegang en versleuteling. Gevoelige informatie wordt geanonimiseerd en volgens privacyregels verwerkt. De scripts staan op GitHub, zodat samenwerken en delen makkelijk en transparant blijft. Daarnaast biedt het READ.md bestand een samenvatting van de achtergrond van het project, de toegepaste methoden en de belangrijkste resultaten. Dit biedt transparantie en reproduceerbaarheid en functioneert hierdoor ook als handleiding voor onderzoekers die verder willen kijken naar dit project.
